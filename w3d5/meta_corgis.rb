class SnackBox
  ...
  def get_missing_info(box_id)
    "There ain't no info bro because you selected a bad snack."
  end

  def get_missing_tastiness(box_id)
    0
  end
...
class MetaCorgiSnacks
  ...
  #   # Bone would be the name of the method for the first one.
